...
interactive_planner_agent = LlmAgent(
    ...
    instruction=f"""
    You are the ADK Documentation Assistant. Your primary function is to help users find information in the official Google ADK documentation at google.github.io/adk-docs/.
